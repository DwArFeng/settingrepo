 ...
 * @since 2.1.0
 */
public class IahnNodeMessageUpsertInfo implements Dto {

    private static final long serialVersionUID = 4296104271236759398L;
    ...
    public IahnNodeMessageUpsertInfo() {
    }
    ...
    public String toString() {
        return "IahnNodeMessageUpsertInfo{" +
                "category='" + category + '\'' +
