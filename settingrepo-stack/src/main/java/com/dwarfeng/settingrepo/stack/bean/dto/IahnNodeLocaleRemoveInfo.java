 ...
 * @since 2.1.0
 */
public class IahnNodeLocaleRemoveInfo implements Dto {

    private static final long serialVersionUID = -4267627568448890196L;
    ...
    public IahnNodeLocaleRemoveInfo() {
    }

    public IahnNodeLocaleRemoveInfo(String category, String[] args, String language, String country, String variant) {
    ...
    public String toString() {
        return "IahnNodeLocaleRemoveInfo{" +
                "category='" + category + '\'' +
