 ...
 * @since 2.4.2
 */
public interface FileListNodeItemMaintainService extends BatchCrudService<LongIdKey, FileListNodeItem>,
        EntireLookupService<FileListNodeItem>, PresetLookupService<FileListNodeItem> {
