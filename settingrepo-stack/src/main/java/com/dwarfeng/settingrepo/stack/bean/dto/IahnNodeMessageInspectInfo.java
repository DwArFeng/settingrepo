 ...
 * @since 2.1.0
 */
public class IahnNodeMessageInspectInfo implements Dto {

    private static final long serialVersionUID = -439749285128921961L;
    ...
    public IahnNodeMessageInspectInfo() {
    }
    ...
    public String toString() {
        return "IahnNodeMessageInspectInfo{" +
                "category='" + category + '\'' +
