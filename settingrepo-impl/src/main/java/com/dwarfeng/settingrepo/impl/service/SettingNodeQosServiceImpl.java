...
@Service
public class SettingNodeQosServiceImpl implements SettingNodeQosService {

    private final SettingNodeOperateHandler settingNodeOperateHandler;

    private final ServiceExceptionMapper sem;

    public SettingNodeQosServiceImpl(SettingNodeOperateHandler settingNodeOperateHandler, ServiceExceptionMapper sem) {
