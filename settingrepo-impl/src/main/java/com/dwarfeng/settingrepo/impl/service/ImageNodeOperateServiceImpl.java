...
@Service
public class ImageNodeOperateServiceImpl implements ImageNodeOperateService {

    private final ImageNodeOperateHandler imageNodeOperateHandler;

    private final ServiceExceptionMapper sem;

    public ImageNodeOperateServiceImpl(ImageNodeOperateHandler imageNodeOperateHandler, ServiceExceptionMapper sem) {
