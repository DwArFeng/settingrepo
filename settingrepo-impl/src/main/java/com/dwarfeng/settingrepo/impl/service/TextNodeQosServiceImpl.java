...
@Service
public class TextNodeQosServiceImpl implements TextNodeQosService {

    private final TextNodeOperateHandler textNodeOperateHandler;

    private final ServiceExceptionMapper sem;

    public TextNodeQosServiceImpl(TextNodeOperateHandler textNodeOperateHandler, ServiceExceptionMapper sem) {
