...
@Table(name = "tbl_file_node")
@EntityListeners(DatamarkEntityListener.class)
public class HibernateFileNode implements Bean {

    private static final long serialVersionUID = -8192371984226693633L;
