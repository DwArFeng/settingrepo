...
public class ResetCommand extends CliCommand {
    ...
    private static final String COMMAND_OPTION_RESET_FORMAT = "reset-format";
    ...
    private static final String CMD_LINE_SYNTAX_RESET_FORMAT = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_FORMAT);
    ...
    protected List<Option> buildOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_FORMAT).desc("执行格式化重置操作").build());
        return list;
    }
        ...
        try {
            ...
            switch (pair.getLeft()) {
                ...
                case COMMAND_OPTION_STATUS:
                    printStatus(context);
                    break;
                case COMMAND_OPTION_RESET_FORMAT:
                    resetQosService.resetFormat();
