...
@Service
public class NavigationNodeOperateServiceImpl implements NavigationNodeOperateService {

    private final NavigationNodeOperateHandler navigationNodeOperateHandler;

    private final ServiceExceptionMapper sem;

    public NavigationNodeOperateServiceImpl(
    ...
    public NavigationNodeSizeResult size(NavigationNodeSizeInfo info) throws ServiceException {
        try {
            ...
            throw ServiceExceptionHelper.logParse("查看导航节点的大小时发生异常", LogLevel.WARN, e, sem);
        }
    }
