...
@Service
public class LongTextNodeQosServiceImpl implements LongTextNodeQosService {

    private final LongTextNodeOperateHandler longTextNodeOperateHandler;

    private final ServiceExceptionMapper sem;

    public LongTextNodeQosServiceImpl(LongTextNodeOperateHandler longTextNodeOperateHandler, ServiceExceptionMapper sem) {
