...
@Repository
public class FileListNodeCacheImpl implements FileListNodeCache {

    private final RedisBatchBaseCache<StringIdKey , FileListNode, FastJsonFileListNode> batchBaseCache;

    public FileListNodeCacheImpl(RedisBatchBaseCache<StringIdKey , FileListNode, FastJsonFileListNode> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public FileListNode get(StringIdKey  key) throws CacheException {
    ...
    public void push(FileListNode value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<FileListNode> batchGet(@SkipRecord List<StringIdKey > keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<FileListNode> entities, long timeout) throws CacheException {
