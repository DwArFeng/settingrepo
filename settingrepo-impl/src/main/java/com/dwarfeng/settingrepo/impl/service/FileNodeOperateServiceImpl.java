...
@Service
public class FileNodeOperateServiceImpl implements FileNodeOperateService {

    private final FileNodeOperateHandler fileNodeOperateHandler;

    private final ServiceExceptionMapper sem;

    public FileNodeOperateServiceImpl(FileNodeOperateHandler fileNodeOperateHandler, ServiceExceptionMapper sem) {
