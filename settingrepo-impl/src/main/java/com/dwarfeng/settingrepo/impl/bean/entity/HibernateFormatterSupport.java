...
@Table(name = "tbl_formatter_support")
public class HibernateFormatterSupport implements Bean {

    private static final long serialVersionUID = -5164348286890483578L;
    ...
    public HibernateFormatterSupport() {
    }
