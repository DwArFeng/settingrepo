...
@Component
public class FormatterSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case FormatterSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case FormatterSupportMaintainService.LABEL_LIKE:
